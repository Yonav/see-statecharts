...
public class SGraphTestFactory extends SGraphFactoryImpl {
	...
	public static Statechart createStatechart(String name) {
		Statechart sc = SGraphFactory.eINSTANCE.createStatechart();
		sc.setName(name);
		return sc;
	}

	public static Region createRegion(Statechart sc, String name) {
	...
	public static Region createRegion(String name, State state) {
		Region region = SGraphFactory.eINSTANCE.createRegion();
		region.setName(name);
		if (state != null)
	...
	public static State createState(Region r, String name) {
	...
	public static FinalState createFinalState(Region r) {
	...
	public static Entry createEntry(EntryKind kind, String name, Region r) {
	...
	public static Exit createExit(String name, Region r) {
	...
	public static Synchronization createSynchronization(Region r) {
	...
	public static Transition createTransition(Vertex source, Vertex target) {
	...
	//------------------
	public static Transition createTransitionWith(Vertex source, Vertex target, Expression guard, List<Expression> effect) {
		Transition transition = createTransition(source, target);
		return transition;
		//transition.setEffect(value);
		//ReactionTrigger trigger = new ReactionTriggerImpl();
